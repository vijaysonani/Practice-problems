...
public class SortedInsertPosition {
  public static void main(String args[]) {
    ...
    System.out.println(new SortedInsertPosition().searchInsert(a, 152));
  }
  ...
  public int searchInsert(ArrayList<Integer> a, int b) {
    ...
    while (mid >= 0) {
      if (target > a.get(mid)) {
        ...
        result += mid;
        a = new ArrayList<Integer>(a.subList(mid, a.size()));
        mid = a.size() / 2;
        ...
        result =  a.get(mid);
        a = new ArrayList<Integer>(a.subList(0, mid));
        mid = a.size() / 2;
      }
    }
...
//     }
//     if (target > nums[mid]) {
//       result = findTarget(Arrays.copyOfRange(nums, mid, nums.length), target);
//     } else if (target == nums[mid]) {
//       return mid;
//     } else {
//       result = findTarget(Arrays.copyOfRange(nums, 0, nums.length), target);
//     }
